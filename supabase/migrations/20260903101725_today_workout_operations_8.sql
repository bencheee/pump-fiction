...
begin
  ...
  if p_operation = 'set_workout_exercise_note' then
    ...
    update public.workout_sets set position = -position where workout_exercise_id = target_set.workout_exercise_id;
    ...
    update public.workout_exercises set position = -position where workout_id = p_workout_id;
...
REVOKE ALL ON FUNCTION "public"."get_current_workout"() FROM PUBLIC;

GRANT EXECUTE ON FUNCTION "public"."get_current_workout"() TO "postgres", "service_role";

REVOKE ALL ON FUNCTION "public"."get_today_view"() FROM PUBLIC;

GRANT EXECUTE ON FUNCTION "public"."get_today_view"() TO "postgres", "service_role";

REVOKE ALL ON FUNCTION "public"."start_workout"(public.workout_source_kind, uuid, text, uuid[], timestamp WITH time zone) FROM PUBLIC;

GRANT EXECUTE ON FUNCTION "public"."start_workout"(public.workout_source_kind, uuid, text, uuid[], timestamp WITH time zone) TO "postgres", "service_role";

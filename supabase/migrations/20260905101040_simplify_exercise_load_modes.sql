...
-- The composite foreign keys below carry the enum columns being replaced, so
-- they are dropped before the type swap and restored with identical behavior.
ALTER TABLE "public"."exercise_load_modes"
...
ALTER TABLE "public"."workout_sets"
  DROP CONSTRAINT "workout_sets_workout_exercise_id_load_mode_fkey";
...
ALTER TYPE "public"."load_mode" RENAME TO "load_mode__pgdelta_replaced";
...
ALTER TABLE "public"."exercise_load_modes"
  ALTER COLUMN "load_mode" TYPE "public"."load_mode" USING "load_mode"::text::"public"."load_mode";
...
DROP TYPE "public"."load_mode__pgdelta_replaced";
...
ALTER TABLE "public"."workout_sets"
  ADD CONSTRAINT "workout_sets_workout_exercise_id_load_mode_fkey"
...
ALTER TABLE "public"."exercise_load_modes"
  ADD CONSTRAINT "exercise_load_modes_check"
    ...
    'bodyweight_resistance_band'::public.load_mode]))) OR
    ((exercise_base_type = 'assisted'::public.exercise_base_type) AND (load_mode = ANY (ARRAY['assistance_weight'::public.load_mode, 'assistance_band'::public.load_mode])))));
...
ALTER TABLE "public"."workout_exercise_load_modes"
  ADD CONSTRAINT "workout_exercise_load_modes_check"
    ...
    'assistance_band'::public.load_mode])))));
...
ALTER TABLE "public"."workout_sets"
  ADD CONSTRAINT "workout_sets_check"
    ...
    ((load_mode = 'assistance_band'::public.load_mode) AND (load_kg IS NULL) AND (band_direction = 'assistance'::public.band_direction) AND (band_strength IS NOT NULL))));

CREATE UNIQUE INDEX exercise_load_modes_single_modifier ON public.exercise_load_modes USING btree (exercise_id)
  WHERE
    (load_mode = ANY (ARRAY['weight_resistance_band'::public.load_mode, 'bodyweight_added_weight'::public.load_mode, 'bodyweight_resistance_band'::public.load_mode,
    'assistance_weight'::public.load_mode, 'assistance_band'::public.load_mode]));

-- Recreating the enum types dropped their grants; restore the initial ones.

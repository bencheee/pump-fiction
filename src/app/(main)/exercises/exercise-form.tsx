      ...
      <main>
        <div>
          ...
          <fieldset disabled={isSaving}>
            <legend>Type</legend>
            <div role="group" aria-label="Exercise type">
          ...
          <fieldset disabled={isSaving}>
            <legend>Set measurement</legend>
            <div role="group" aria-label="Set measurement options">
          ...
          <fieldset disabled={isSaving}>
            <legend>Optional per-set additions</legend>
            <p>{baseModeSummary(baseType, measurementType)}</p>
            <div>
            ...
            {modeNotice ? <p>{modeNotice}</p> : null}
            {errors.allowedLoadModes ? (
              <p id="allowed-modes-error" role="alert">

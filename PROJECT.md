...
- **Last updated:** 2026-09-05T12:03:40+02:00
...
User reviews delivery commit `613dae3da605c329e22e07a82a7b9d1439c0320b` for [`T-018`](docs/project/tasks/T-018-return-to-parent-screen-after-saving.md) and decides on approval; feature tests stay blocked until that approval. The proposed current-program mechanism in [`T-021`](docs/project/tasks/T-021-replace-archiving-with-deletion-in-data.md) and the per-set control placement in [`T-020`](docs/project/tasks/T-020-derive-per-set-load-from-definition.md) still need Owner confirmation before those Tasks become `Ready`.
...
- [`F-011`](docs/project/features/F-011-mvp-experience-corrections.md) — MVP Experience Corrections (`0/7 Tasks Done`) — Owner confirmed readiness
  - [`T-018`](docs/project/tasks/T-018-return-to-parent-screen-after-saving.md) — `In Review` — Claude Code primary agent — `2026-09-05T12:03:40+02:00` — User reviews `613dae3da605c329e22e07a82a7b9d1439c0320b` (corrections 1 and 4)

...
- **Last updated:** 2026-09-05T20:36:12+02:00
...
- [`F-014`](docs/project/features/F-014-exercise-and-set-entry-model.md) — Exercise and Set-Entry Model Corrections (`0/2 Tasks Done`) — two exercise types with assistance under bodyweight, then values instead of confirmation
  - [`T-028`](docs/project/tasks/T-028-merge-assisted-into-bodyweight.md) — `In Review` — Claude Code primary agent — `2026-09-05T20:36:12+02:00` — review `481ef7dc410733ad1b0502a8cea0a02ac53259bc`; the reset, pgTAP, and the suites need the Owner's approval of that SHA

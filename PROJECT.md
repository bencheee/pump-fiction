...
- **Last updated:** 2026-09-05T12:09:18+02:00
...
Deliver [`T-019`](docs/project/tasks/T-019-simplify-exercise-load-mode-model.md) as one reviewable commit covering the schema, domain, Exercise Library, and revised criteria. The proposed current-program mechanism in [`T-021`](docs/project/tasks/T-021-replace-archiving-with-deletion-in-data.md) and the per-set control placement in [`T-020`](docs/project/tasks/T-020-derive-per-set-load-from-definition.md) still need Owner confirmation before those Tasks become `Ready`.
...
- [`F-011`](docs/project/features/F-011-mvp-experience-corrections.md) — MVP Experience Corrections (`1/7 Tasks Done`) — Owner confirmed readiness
  ...
  - [`T-019`](docs/project/tasks/T-019-simplify-exercise-load-mode-model.md) — `In Progress` — Claude Code primary agent — `2026-09-05T12:09:18+02:00` — deliver one reviewable commit (correction 2)

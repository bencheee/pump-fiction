...
- **Last updated:** 2026-09-06T13:15:07+02:00
...
- **Implementation:** `F-004` through `F-008` and `F-011` through `F-014` complete; `F-009` is released and `T-038` of its five Tasks awaits the Owner's approval
...
[`T-038`](docs/project/tasks/T-038-build-weight-operations.md) — Build weight operations — `In Review`, Executor Claude Code primary agent, last change 2026-09-06T13:15:07+02:00. Exact delivery `94196f3be1f8f7b47b204637a16cc30d0520e916` awaits the Owner's approval. It derives and persists everything `S19`, `S20`, and the Today weight prompt need: the Monday–Sunday weekly average and change, the provisional rule, the individual change, the chart series, and the create, update, and delete writes.
...
The Owner reviews and approves exact delivery `94196f3be1f8f7b47b204637a16cc30d0520e916`. Only then does the recorded plan run: the unit suites, a seeded reset, pgTAP, the repository suite, and the type comparison. The Owner's word is also still open on two discovered items without a Task: the finish review's `Confirmed sets` copy, and one rule for the two test-support harnesses.

## Now

- [`T-038`](docs/project/tasks/T-038-build-weight-operations.md) — Build weight operations — `In Review` — Claude Code primary agent — 2026-09-06T13:15:07+02:00 — next: the Owner's approval of `94196f3be1f8f7b47b204637a16cc30d0520e916`.
...
- [`T-038`](docs/project/tasks/T-038-build-weight-operations.md) — Build weight operations — exact delivery `94196f3be1f8f7b47b204637a16cc30d0520e916` — Claude Code primary agent — 2026-09-06T13:15:07+02:00 — requested action: review and approve that commit, which authorizes the recorded verification.

...
- **Last updated:** 2026-09-09T12:25:00+02:00
...
[`F-016`](docs/project/features/F-016-today-preview-and-workout-density.md) — Today Preview and Workout Density. [`T-054`](docs/project/tasks/T-054-refine-today-and-active-workout-density.md) is back `In Progress` for an in-scope replacement requested by the Owner.

## Immediate next action

Deliver the `T-054` replacement with one-row sets and the single-open, initially collapsed exercise-card accordion. Feature tests remain approval-gated.

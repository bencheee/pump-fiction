...
- **Last updated:** 2026-09-05T21:18:30+02:00
...
- [`F-014`](docs/project/features/F-014-exercise-and-set-entry-model.md) — Exercise and Set-Entry Model Corrections (`1/2 Tasks Done`) — the two-type model is verified; values instead of confirmation remain
  - [`T-029`](docs/project/tasks/T-029-record-a-set-by-its-values.md) — `In Review` — Claude Code primary agent — `2026-09-05T21:18:30+02:00` — review `a64adcc3a1b547ac2af2ec9121c958653323d2f2`; the reset and the suites need the Owner's approval of that SHA

...
- **Last updated:** 2026-09-05T12:42:09+02:00
...
- [`F-011`](docs/project/features/F-011-mvp-experience-corrections.md) — MVP Experience Corrections (`3/6 Tasks Done`) — Owner confirmed readiness
  ...
  - [`T-021`](docs/project/tasks/T-021-replace-archiving-with-deletion-in-data.md) — `In Progress` — Claude Code primary agent — `2026-09-05T12:42:09+02:00` — deliver one reviewable commit (correction 3)

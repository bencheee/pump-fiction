...
- **Last updated:** 2026-09-05T12:06:25+02:00
...
Run and record the authorized component tests for approved [`T-018`](docs/project/tasks/T-018-return-to-parent-screen-after-saving.md) commit `613dae3da605c329e22e07a82a7b9d1439c0320b`. The proposed current-program mechanism in [`T-021`](docs/project/tasks/T-021-replace-archiving-with-deletion-in-data.md) and the per-set control placement in [`T-020`](docs/project/tasks/T-020-derive-per-set-load-from-definition.md) still need Owner confirmation before those Tasks become `Ready`.
...
- [`T-018`](docs/project/tasks/T-018-return-to-parent-screen-after-saving.md) — approved commit `613dae3da605c329e22e07a82a7b9d1439c0320b`; authorized component scenarios are running.

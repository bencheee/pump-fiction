...
- **Last updated:** 2026-09-05T21:21:57+02:00
...
- [`F-014`](docs/project/features/F-014-exercise-and-set-entry-model.md) — Exercise and Set-Entry Model Corrections (`1/2 Tasks Done`) — the two-type model is verified; values instead of confirmation remain
  - [`T-029`](docs/project/tasks/T-029-record-a-set-by-its-values.md) — `In Progress` — Claude Code primary agent — `2026-09-05T21:21:57+02:00` — the authorized run failed on two stale component expectations; deliver a replacement

...
- **Last updated:** 2026-09-05T13:20:44+02:00
...
Run and record the authorized component verification for approved [`T-024`](docs/project/tasks/T-024-keep-primary-navigation-during-workout.md) commit `09a2477e18686ac7aa776b6b52c6c45d35adaad2`. The proposed current-program mechanism in [`T-021`](docs/project/tasks/T-021-replace-archiving-with-deletion-in-data.md) and the per-set control placement in [`T-020`](docs/project/tasks/T-020-derive-per-set-load-from-definition.md) still need Owner confirmation before those Tasks become `Ready`.
...
- [`F-011`](docs/project/features/F-011-mvp-experience-corrections.md) — MVP Experience Corrections (`5/6 Tasks Done`) — Owner confirmed readiness
  ...
  - [`T-024`](docs/project/tasks/T-024-keep-primary-navigation-during-workout.md) — `Testing` — Claude Code primary agent — `2026-09-05T13:16:19+02:00` — deliver one reviewable commit (correction 9)
...
- [`T-024`](docs/project/tasks/T-024-keep-primary-navigation-during-workout.md) — approved commit `09a2477e18686ac7aa776b6b52c6c45d35adaad2`; the authorized component scenarios are running.

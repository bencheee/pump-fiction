...
- **Last updated:** 2026-09-05T13:15:27+02:00
...
- [`F-011`](docs/project/features/F-011-mvp-experience-corrections.md) — MVP Experience Corrections (`4/6 Tasks Done`) — Owner confirmed readiness
  ...
  - [`T-023`](docs/project/tasks/T-023-correct-active-workout-screen-details.md) — `Testing` — Claude Code primary agent — `2026-09-05T13:11:36+02:00` — deliver one reviewable commit (corrections 5, 6, 8)
...
- [`T-023`](docs/project/tasks/T-023-correct-active-workout-screen-details.md) — approved commit `f72e7dde3bcc9cb8f80d98935e42e7411603403f`; the authorized component scenarios are running.
...
- [`F-011`](docs/project/features/F-011-mvp-experience-corrections.md) — MVP Experience Corrections (`4/6 Tasks Done`)

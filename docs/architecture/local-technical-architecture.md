...
- Archived entities remain addressable only where canonical product behavior explicitly exposes archived history or reactivation; an otherwise unavailable identifier uses the same not-found boundary

...
- [`T-012`](../tasks/T-012-build-program-and-split-operations.md) — Build program and split operations (`Testing`; approved replacement `5b781802d2bddfc77b55745f12108ae678bd2b76`)

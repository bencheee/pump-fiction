...
| --- | --- | --- | --- |
| 1 | [`T-038`](../tasks/T-038-build-weight-operations.md) — Build weight operations | Weight entry validation and writes, Monday–Sunday weekly derivation, chart series, weight queries | `F-004`, `T-033`, and `T-035` Done (schema, chart contract, range helper) |

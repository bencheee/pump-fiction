...
- [`T-017`](../tasks/T-017-correct-one-time-workout-starter-sets.md) — Correct one-time workout starter sets (`In Progress`; required OD-001 correction)
...
- Blockers: None for `T-017`; `T-015` waits for the required correction

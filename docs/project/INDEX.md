...
| [`T-027`](tasks/T-027-restore-local-data-after-reset.md) | `F-013` | Restore usable local data after a verification reset | `Now / 1` | `Testing` | Claude Code primary agent | `2026-09-05T19:57:07+02:00` | [`tasks/T-027-restore-local-data-after-reset.md`](tasks/T-027-restore-local-data-after-reset.md) |

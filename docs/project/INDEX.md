...
| [`F-009`](features/F-009-weight-and-body-progress.md) | `M-001` | Weight and Body Progress | `Now / 2` | `0/5 Done; T-038 In Review` | User | `2026-09-06T13:15:07+02:00` | [`features/F-009-weight-and-body-progress.md`](features/F-009-weight-and-body-progress.md) |
...
| [`T-038`](tasks/T-038-build-weight-operations.md) | `F-009` | Build weight operations | `Now / 1` | `In Review` | Claude Code primary agent | `2026-09-06T13:15:07+02:00` | [`tasks/T-038-build-weight-operations.md`](tasks/T-038-build-weight-operations.md) |

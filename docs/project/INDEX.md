...
| [`F-011`](features/F-011-mvp-experience-corrections.md) | `M-001` | MVP Experience Corrections | `Now / 1` | `5/6 Done` | User | `2026-09-05T12:07:13+02:00` | [`features/F-011-mvp-experience-corrections.md`](features/F-011-mvp-experience-corrections.md) |
...
| [`T-024`](tasks/T-024-keep-primary-navigation-during-workout.md) | `F-011` | Keep primary navigation during an active workout | `Now / 7` | `In Progress` | Claude Code primary agent | `2026-09-05T13:16:19+02:00` | [`tasks/T-024-keep-primary-navigation-during-workout.md`](tasks/T-024-keep-primary-navigation-during-workout.md) |

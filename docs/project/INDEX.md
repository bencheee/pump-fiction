...
| [`F-011`](features/F-011-mvp-experience-corrections.md) | `M-001` | MVP Experience Corrections | `Now / 1` | `2/7 Done` | User | `2026-09-05T12:07:13+02:00` | [`features/F-011-mvp-experience-corrections.md`](features/F-011-mvp-experience-corrections.md) |
...
| [`T-020`](tasks/T-020-derive-per-set-load-from-definition.md) | `F-011` | Derive per-set load from the exercise definition | `Now / 3` | `In Progress` | Claude Code primary agent | `2026-09-05T12:33:15+02:00` | [`tasks/T-020-derive-per-set-load-from-definition.md`](tasks/T-020-derive-per-set-load-from-definition.md) |

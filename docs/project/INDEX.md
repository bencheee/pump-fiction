...
| [`F-011`](features/F-011-mvp-experience-corrections.md) | `M-001` | MVP Experience Corrections | `Now / 1` | `1/7 Done` | User | `2026-09-05T12:07:13+02:00` | [`features/F-011-mvp-experience-corrections.md`](features/F-011-mvp-experience-corrections.md) |
...
| [`T-019`](tasks/T-019-simplify-exercise-load-mode-model.md) | `F-011` | Simplify the exercise load-mode model | `Now / 2` | `In Progress` | Claude Code primary agent | `2026-09-05T12:09:18+02:00` | [`tasks/T-019-simplify-exercise-load-mode-model.md`](tasks/T-019-simplify-exercise-load-mode-model.md) |

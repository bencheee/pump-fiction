...
| [`F-007`](features/F-007-today-and-active-workout.md) | `M-001` | Today and Active Workout | `Now / 1` | `1/4 Done` | User | `2026-09-04T09:06:26+02:00` | [`features/F-007-today-and-active-workout.md`](features/F-007-today-and-active-workout.md) |
...
| [`T-017`](tasks/T-017-correct-one-time-workout-starter-sets.md) | `F-007` | Correct one-time workout starter sets | `Now / 2` | `In Review` | Codex primary agent | `2026-09-04T09:06:26+02:00` | [`tasks/T-017-correct-one-time-workout-starter-sets.md`](tasks/T-017-correct-one-time-workout-starter-sets.md) |

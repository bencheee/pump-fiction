...
| [`T-043`](tasks/T-043-record-release-verification-matrix.md) | `F-010` | Record the release verification matrix | `Now / 1` | `In Progress` | Claude Code primary agent | `2026-09-06T15:04:00+02:00` | [`tasks/T-043-record-release-verification-matrix.md`](tasks/T-043-record-release-verification-matrix.md) |

...
| [`T-020`](tasks/T-020-derive-per-set-load-from-definition.md) | `F-011` | Derive per-set load from the exercise definition | `Now / 3` | `Testing` | Claude Code primary agent | `2026-09-05T12:36:44+02:00` | [`tasks/T-020-derive-per-set-load-from-definition.md`](tasks/T-020-derive-per-set-load-from-definition.md) |

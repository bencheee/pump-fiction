...
| --- | --- | --- | --- | --- | --- | --- |
| [`M-001`](milestones/M-001-local-mvp.md) | Local MVP | `Now / 1` | `3/10 Features Done` | User | `2026-08-31T12:06:31+02:00` | [`milestones/M-001-local-mvp.md`](milestones/M-001-local-mvp.md) |
...
| [`F-004`](features/F-004-application-and-data-foundation.md) | `M-001` | Application and Data Foundation | `Now / 1` | `0/5 Done; T-005 In Progress` | User | `2026-08-31T12:06:31+02:00` | [`features/F-004-application-and-data-foundation.md`](features/F-004-application-and-data-foundation.md) |
...
| [`T-005`](tasks/T-005-initialize-application-and-static-quality.md) | `F-004` | Initialize application and static-quality baseline | `Now / 1` | `In Progress` | Codex primary agent | `2026-08-31T12:06:31+02:00` | [`tasks/T-005-initialize-application-and-static-quality.md`](tasks/T-005-initialize-application-and-static-quality.md) |
...
| [`T-008`](tasks/T-008-build-active-workout-durability.md) | `F-004` | Build active-workout command durability foundation | `Next / 4` | `Backlog` | Codex primary agent | `2026-08-31T11:43:22+02:00` | [`tasks/T-008-build-active-workout-durability.md`](tasks/T-008-build-active-workout-durability.md) |
| [`T-009`](tasks/T-009-build-mobile-shell-and-ui-foundation.md) | `F-004` | Build mobile shell and shared UI foundation | `Next / 5` | `Backlog` | Codex primary agent | `2026-08-31T11:43:22+02:00` | [`tasks/T-009-build-mobile-shell-and-ui-foundation.md`](tasks/T-009-build-mobile-shell-and-ui-foundation.md) |

...
| [`F-013`](features/F-013-local-verification-data.md) | `M-001` | Local Verification Data | `Now / 1` | `0/1 Done` | User | `2026-09-05T19:51:11+02:00` | [`features/F-013-local-verification-data.md`](features/F-013-local-verification-data.md) |
...
| [`T-027`](tasks/T-027-restore-local-data-after-reset.md) | `F-013` | Restore usable local data after a verification reset | `Now / 1` | `In Review` | Claude Code primary agent | `2026-09-05T19:51:11+02:00` | [`tasks/T-027-restore-local-data-after-reset.md`](tasks/T-027-restore-local-data-after-reset.md) |

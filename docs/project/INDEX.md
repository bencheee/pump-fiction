...
| [`T-021`](tasks/T-021-replace-archiving-with-deletion-in-data.md) | `F-011` | Replace archiving with deletion in data and operations | `Now / 4` | `In Review` | Claude Code primary agent | `2026-09-05T13:00:15+02:00` | [`tasks/T-021-replace-archiving-with-deletion-in-data.md`](tasks/T-021-replace-archiving-with-deletion-in-data.md) |

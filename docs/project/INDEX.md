...
| [`T-026`](tasks/T-026-recover-from-rejected-command.md) | `F-012` | Recover from a permanently rejected active-workout command | `Now / 1` | `In Review` | Claude Code primary agent | `2026-09-05T21:35:40+02:00` | [`tasks/T-026-recover-from-rejected-command.md`](tasks/T-026-recover-from-rejected-command.md) |

...
| [`F-009`](features/F-009-weight-and-body-progress.md) | `M-001` | Weight and Body Progress | `Now / 2` | `2/5 Done; T-040 Testing` | User | `2026-09-06T13:48:55+02:00` | [`features/F-009-weight-and-body-progress.md`](features/F-009-weight-and-body-progress.md) |
...
| [`T-040`](tasks/T-040-add-todays-weight-prompt.md) | `F-009` | Add today's weight prompt to Today | `Now / 3` | `Testing` | Claude Code primary agent | `2026-09-06T13:48:55+02:00` | [`tasks/T-040-add-todays-weight-prompt.md`](tasks/T-040-add-todays-weight-prompt.md) |

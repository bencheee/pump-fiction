...
| --- | --- | --- | --- | --- | --- | --- |
| [`M-001`](milestones/M-001-local-mvp.md) | Local MVP | `Now / 1` | `1/10 Done; 1 awaiting approval` | User | `2026-08-25T16:47:34+02:00` | [`milestones/M-001-local-mvp.md`](milestones/M-001-local-mvp.md) |
...
| [`F-002`](features/F-002-mvp-delivery-planning.md) | `M-001` | MVP Delivery Planning | `Now / 2` | `0/1 Done; 1 awaiting approval` | User | `2026-08-25T16:47:34+02:00` | [`features/F-002-mvp-delivery-planning.md`](features/F-002-mvp-delivery-planning.md) |
| [`F-003`](features/F-003-mobile-ui-ux-design-package.md) | `M-001` | Mobile UI/UX Design Package | `Next / 1` | `0/2 Done` | User | `2026-08-25T16:35:55+02:00` | [`features/F-003-mobile-ui-ux-design-package.md`](features/F-003-mobile-ui-ux-design-package.md) |
...
| [`T-002`](tasks/T-002-define-mvp-delivery-and-design-workflow.md) | `F-002` | Define MVP delivery and external-design workflow | `Now / 1` | `Awaiting Approval` | Codex primary agent | `2026-08-25T16:47:34+02:00` | [`tasks/T-002-define-mvp-delivery-and-design-workflow.md`](tasks/T-002-define-mvp-delivery-and-design-workflow.md) |
| [`T-003`](tasks/T-003-prepare-mobile-design-agent-brief.md) | `F-003` | Prepare mobile design-agent brief and wireframes | `Next / 1` | `Backlog` | Codex primary agent | `2026-08-25T16:35:55+02:00` | [`tasks/T-003-prepare-mobile-design-agent-brief.md`](tasks/T-003-prepare-mobile-design-agent-brief.md) |

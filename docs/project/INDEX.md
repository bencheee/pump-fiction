...
| [`T-030`](tasks/T-030-clean-up-command-test-exercise.md) | `F-013` | Delete the exercise the command repository test creates | `Now / 1` | `In Progress` | Claude Code primary agent | `2026-09-05T20:16:37+02:00` | [`tasks/T-030-clean-up-command-test-exercise.md`](tasks/T-030-clean-up-command-test-exercise.md) |

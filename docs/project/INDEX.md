...
| [`F-014`](features/F-014-exercise-and-set-entry-model.md) | `M-001` | Exercise and Set-Entry Model Corrections | `Now / 1` | `1/2 Done` | User | `2026-09-05T21:05:10+02:00` | [`features/F-014-exercise-and-set-entry-model.md`](features/F-014-exercise-and-set-entry-model.md) |
...
| [`T-029`](tasks/T-029-record-a-set-by-its-values.md) | `F-014` | Record a set by its entered values | `Now / 1` | `In Progress` | Claude Code primary agent | `2026-09-05T21:07:30+02:00` | [`tasks/T-029-record-a-set-by-its-values.md`](tasks/T-029-record-a-set-by-its-values.md) |

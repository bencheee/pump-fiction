...
| [`F-011`](features/F-011-mvp-experience-corrections.md) | `M-001` | MVP Experience Corrections | `Now / 1` | `3/6 Done` | User | `2026-09-05T12:07:13+02:00` | [`features/F-011-mvp-experience-corrections.md`](features/F-011-mvp-experience-corrections.md) |
...
| [`T-021`](tasks/T-021-replace-archiving-with-deletion-in-data.md) | `F-011` | Replace archiving with deletion in data and operations | `Now / 4` | `In Progress` | Claude Code primary agent | `2026-09-05T13:00:15+02:00` | [`tasks/T-021-replace-archiving-with-deletion-in-data.md`](tasks/T-021-replace-archiving-with-deletion-in-data.md) |

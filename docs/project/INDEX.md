...
| [`F-004`](features/F-004-application-and-data-foundation.md) | `M-001` | Application and Data Foundation | `Now / 1` | `3/5 Done; T-008 test-script replacement pending delivery` | User | `2026-09-01T09:05:32+02:00` | [`features/F-004-application-and-data-foundation.md`](features/F-004-application-and-data-foundation.md) |
...
| [`T-008`](tasks/T-008-build-active-workout-durability.md) | `F-004` | Build active-workout command durability foundation | `Now / 1` | `In Progress` | Codex primary agent | `2026-09-01T09:05:32+02:00` | [`tasks/T-008-build-active-workout-durability.md`](tasks/T-008-build-active-workout-durability.md) |

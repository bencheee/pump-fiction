...
| [`F-006`](features/F-006-programs-and-splits.md) | `M-001` | Programs and Splits | `Now / 1` | `1/2 Tasks Done` | User | `2026-09-03T10:47:48+02:00` | [`features/F-006-programs-and-splits.md`](features/F-006-programs-and-splits.md) |
...
| [`T-013`](tasks/T-013-build-programs-mobile-experience.md) | `F-006` | Build Programs mobile experience | `Now / 2` | `In Review` | Codex primary agent | `2026-09-03T10:47:48+02:00` | [`tasks/T-013-build-programs-mobile-experience.md`](tasks/T-013-build-programs-mobile-experience.md) |

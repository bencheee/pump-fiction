...
| [`F-006`](features/F-006-programs-and-splits.md) | `M-001` | Programs and Splits | `Now / 1` | `0/2 Tasks Done` | User | `2026-09-02T15:07:10+02:00` | [`features/F-006-programs-and-splits.md`](features/F-006-programs-and-splits.md) |
...
| [`T-012`](tasks/T-012-build-program-and-split-operations.md) | `F-006` | Build program and split operations | `Now / 1` | `Testing` | Codex primary agent | `2026-09-02T15:07:10+02:00` | [`tasks/T-012-build-program-and-split-operations.md`](tasks/T-012-build-program-and-split-operations.md) |

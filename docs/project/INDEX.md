...
| [`F-014`](features/F-014-exercise-and-set-entry-model.md) | `M-001` | Exercise and Set-Entry Model Corrections | `Now / 1` | `0/2 Done` | User | `2026-09-05T20:24:07+02:00` | [`features/F-014-exercise-and-set-entry-model.md`](features/F-014-exercise-and-set-entry-model.md) |
...
| [`T-028`](tasks/T-028-merge-assisted-into-bodyweight.md) | `F-014` | Merge assisted exercises into bodyweight options | `Now / 1` | `In Progress` | Claude Code primary agent | `2026-09-05T20:59:40+02:00` | [`tasks/T-028-merge-assisted-into-bodyweight.md`](tasks/T-028-merge-assisted-into-bodyweight.md) |

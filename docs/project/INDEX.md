...
| [`T-019`](tasks/T-019-simplify-exercise-load-mode-model.md) | `F-011` | Simplify the exercise load-mode model | `Now / 2` | `Testing` | Claude Code primary agent | `2026-09-05T12:27:32+02:00` | [`tasks/T-019-simplify-exercise-load-mode-model.md`](tasks/T-019-simplify-exercise-load-mode-model.md) |

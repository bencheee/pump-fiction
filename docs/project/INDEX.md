...
| [`F-004`](features/F-004-application-and-data-foundation.md) | `M-001` | Application and Data Foundation | `Now / 1` | `0/5 Done; T-005 In Review` | User | `2026-08-31T12:26:36+02:00` | [`features/F-004-application-and-data-foundation.md`](features/F-004-application-and-data-foundation.md) |
...
| [`T-005`](tasks/T-005-initialize-application-and-static-quality.md) | `F-004` | Initialize application and static-quality baseline | `Now / 1` | `In Review` | Codex primary agent | `2026-08-31T12:26:36+02:00` | [`tasks/T-005-initialize-application-and-static-quality.md`](tasks/T-005-initialize-application-and-static-quality.md) |

...
| [`F-004`](features/F-004-application-and-data-foundation.md) | `M-001` | Application and Data Foundation | `Now / 1` | `1/5 Done; T-006 In Progress` | User | `2026-08-31T15:12:56+02:00` | [`features/F-004-application-and-data-foundation.md`](features/F-004-application-and-data-foundation.md) |
...
| [`T-006`](tasks/T-006-establish-local-database-schema.md) | `F-004` | Establish local database schema and generated types | `Now / 1` | `In Progress` | Codex primary agent | `2026-08-31T15:12:56+02:00` | [`tasks/T-006-establish-local-database-schema.md`](tasks/T-006-establish-local-database-schema.md) |

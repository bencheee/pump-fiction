...
| [`T-029`](tasks/T-029-record-a-set-by-its-values.md) | `F-014` | Record a set by its entered values | `Now / 1` | `Testing` | Claude Code primary agent | `2026-09-05T21:24:47+02:00` | [`tasks/T-029-record-a-set-by-its-values.md`](tasks/T-029-record-a-set-by-its-values.md) |

...
| [`F-011`](features/F-011-mvp-experience-corrections.md) | `M-001` | MVP Experience Corrections | `Now / 1` | `0/7 Done` | User | `2026-09-05T11:41:11+02:00` | [`features/F-011-mvp-experience-corrections.md`](features/F-011-mvp-experience-corrections.md) |
...
| [`T-018`](tasks/T-018-return-to-parent-screen-after-saving.md) | `F-011` | Return to the parent screen after saving | `Now / 1` | `In Progress` | Claude Code primary agent | `2026-09-05T11:54:40+02:00` | [`tasks/T-018-return-to-parent-screen-after-saving.md`](tasks/T-018-return-to-parent-screen-after-saving.md) |
| [`T-019`](tasks/T-019-simplify-exercise-load-mode-model.md) | `F-011` | Simplify the exercise load-mode model | `Now / 2` | `Backlog` | Claude Code primary agent | `2026-09-05T11:41:11+02:00` | [`tasks/T-019-simplify-exercise-load-mode-model.md`](tasks/T-019-simplify-exercise-load-mode-model.md) |
| [`T-020`](tasks/T-020-derive-per-set-load-from-definition.md) | `F-011` | Derive per-set load from the exercise definition | `Now / 3` | `Backlog` | Claude Code primary agent | `2026-09-05T11:41:11+02:00` | [`tasks/T-020-derive-per-set-load-from-definition.md`](tasks/T-020-derive-per-set-load-from-definition.md) |
| [`T-021`](tasks/T-021-replace-archiving-with-deletion-in-data.md) | `F-011` | Replace archiving with deletion in data and operations | `Now / 4` | `Backlog` | Claude Code primary agent | `2026-09-05T11:41:11+02:00` | [`tasks/T-021-replace-archiving-with-deletion-in-data.md`](tasks/T-021-replace-archiving-with-deletion-in-data.md) |
| [`T-022`](tasks/T-022-replace-archiving-in-mobile-experience.md) | `F-011` | Replace archiving in the mobile experience | `Now / 5` | `Backlog` | Claude Code primary agent | `2026-09-05T11:41:11+02:00` | [`tasks/T-022-replace-archiving-in-mobile-experience.md`](tasks/T-022-replace-archiving-in-mobile-experience.md) |
| [`T-023`](tasks/T-023-correct-active-workout-screen-details.md) | `F-011` | Correct active-workout screen details | `Now / 6` | `Backlog` | Claude Code primary agent | `2026-09-05T11:41:11+02:00` | [`tasks/T-023-correct-active-workout-screen-details.md`](tasks/T-023-correct-active-workout-screen-details.md) |
| [`T-024`](tasks/T-024-keep-primary-navigation-during-workout.md) | `F-011` | Keep primary navigation during an active workout | `Now / 7` | `Backlog` | Claude Code primary agent | `2026-09-05T11:41:11+02:00` | [`tasks/T-024-keep-primary-navigation-during-workout.md`](tasks/T-024-keep-primary-navigation-during-workout.md) |
